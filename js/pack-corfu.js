...
var NIGHTS = [
  {
    ...
    symbol: '\u{1F531}', badges: ['god-poseidon'],
  ...
  },
  {
    ...
    symbol: '\u{1F989}', badges: ['god-athena'],
  ...
  },
  {
    ...
    symbol: '\u{1FA76}', badges: ['god-hermes'],
  ...
  },
  {
    ...
    symbol: '\u{1F3F9}', badges: ['god-apollo', 'god-artemis'],
  ...
  },
  {
    ...
    symbol: '\u{1F99A}', badges: ['god-hera', 'god-ares'],
  ...
  },
  {
    ...
    symbol: '\u{1F528}', badges: ['god-hephaestus', 'god-aphrodite'],
  ...
  },
  {
    ...
    symbol: '\u{1F347}', badges: ['god-demeter', 'god-dionysus'],
...
var QUESTS = [
  {
    ...
    symbol: '\u{1F6A2}', badgeId: 'hero-odysseus', badgeName: "Odysseus's Compass", points: 30,
  ...
  },
  {
    ...
    symbol: '\u{1F3DB}', badgeId: 'hero-achilles', badgeName: "Achilles' Shield", points: 30,
  ...
  },
  {
    ...
    symbol: '\u{1F3D6}', badgeId: null, badgeName: null, points: 20,
...
// The badge collection: 12 gods + 6 heroes + guest + pantheon (art in assets/badges/).
var GOD_BADGES = [
  { id: 'god-poseidon',   name: 'Poseidon',   night: 1 },
  { id: 'god-zeus',       name: 'Zeus',       night: 2 },
  { id: 'god-athena',     name: 'Athena',     night: 3 },
  { id: 'god-hermes',     name: 'Hermes',     night: 4 },
  { id: 'god-apollo',     name: 'Apollo',     night: 5 },
  { id: 'god-artemis',    name: 'Artemis',    night: 5 },
  { id: 'god-hera',       name: 'Hera',       night: 6 },
  { id: 'god-ares',       name: 'Ares',       night: 6 },
  { id: 'god-hephaestus', name: 'Hephaestus', night: 7 },
  { id: 'god-aphrodite',  name: 'Aphrodite',  night: 7 },
  { id: 'god-demeter',    name: 'Demeter',    night: 8 },
  { id: 'god-dionysus',   name: 'Dionysus',   night: 8 }
];
GOD_BADGES.forEach(function (g) {
  BADGES.push({ id: g.id, img: 'assets/badges/badge-' + g.id.slice(4) + '.svg', name: g.name, how: 'Night ' + g.night + ': finish the Showdown', god: true });
});
BADGES.push(
  { id: 'hero-odysseus',  img: 'assets/badges/badge-odysseus.svg',  name: 'Odysseus',  how: 'Quest: The Stone Ship of Mouse Island', god: true },
  { id: 'hero-achilles',  img: 'assets/badges/badge-achilles.svg',  name: 'Achilles',  how: 'Quest: The Palace of the Fastest Hero', god: true },
  { id: 'hero-theseus',   img: 'assets/badges/badge-theseus.svg',   name: 'Theseus',   how: 'Opens on the road to Athens', god: true, sealed: true },
  { id: 'hero-hercules',  img: 'assets/badges/badge-hercules.svg',  name: 'Hercules',  how: 'Opens at Nemea', god: true, sealed: true },
  { id: 'hero-perseus',   img: 'assets/badges/badge-perseus.svg',   name: 'Perseus',   how: 'Opens at Mycenae', god: true, sealed: true },
  { id: 'hero-asclepius', img: 'assets/badges/badge-asclepius.svg', name: 'Asclepius', how: 'Opens at Epidaurus', god: true, sealed: true },
  { id: 'pantheon',       img: 'assets/badges/badge-pantheon.svg',  name: 'The Pantheon', how: 'Collect all 12 gods of Olympus', god: true }
);
window.GUEST_BADGE_IMG = 'assets/badges/badge-guest.svg';
